...
<input type="hidden" id ="myRealTimeSummaryView" value="${myRealTimeSummaryView}"/>
                ...
                <div id="paneOneTotalDiv" class="container-fluid">
                    ...
                    <div id="tabOneInsidPaneOne" class="infoDiv container-fluid">
                        ...
                        <ul class="floatingBoxContainers" id="transactionList" <c:if test="${urlParam == 0}">style="display:none"</c:if>>
                            <c:if test="${myRealTimeSummaryView == 0}">
                                <security:authorize ifAnyGranted="${adminUser}, ${ia_analyst}">
                                    <div id ="assignBtn" class="alert alert-error">
                                        <button type="button" id="assignedBtn" class="btn btn-mini btn-success"><i class="icon-ok"></i>&nbsp;&nbsp;<spring:message code="complete.assignment" /></button>
                                    </div>
                                </security:authorize>
                            </c:if>
                            <li>

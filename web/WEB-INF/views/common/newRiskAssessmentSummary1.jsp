                        ...
                        <div id="paneOneTotalDiv" class="container-fluid">
                            ...
                            <div class="floatingBoxMenu">
                                <ul class="nav nav-tabs">
                                    <li class="active" id="summaryOfThirdPartyTransactionsLi"><a href="#summaryOfThirdPartyTransactions"><spring:message code="newRiskAssessmentSummary.summaryOfThirdPartyTransactions" /></a></li>
                                    <li id="transactionListLi"><a href="#transactionList"><spring:message code="newRiskAssessmentSummary.transactionList" /></a></li>
                                </ul>
                            </div>
                            ...
                            <div id="tabOneInsidPaneOne" class="infoDiv container-fluid">
                                ...
                                <ul class="floatingBoxContainers" id="transactionList" style="display:none">
                                    <li>
                                ...
                                <ul class="floatingBoxContainers" id="summaryOfThirdPartyTransactions">

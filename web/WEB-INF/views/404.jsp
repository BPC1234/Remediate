    ...
    <div class="row-fluid">
        ...
        <div class="span8 page404-container">
            ...
            <div class="buttonHolder">
                ...
                <a class="btn btn-small btn-danger" href="./landingPage.html"><i class="icon-home"></i> Return to home</a>
            </div>
        </div>
        <div class="span2"></div>
    </div>
...
<script>window.jQuery || document.write('<script src="<%= contextPath %>/resources/kamarel/js/vendor/jquery-1.9.1.min.js"><\/script>')</script>

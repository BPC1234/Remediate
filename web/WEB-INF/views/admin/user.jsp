...
<div class="row-fluid">
    ...
    <div class="span6">
        ...
        <div class="containerHeadline">
            <i class="icon-ok-sign"></i><h2><spring:message code="adminHeader.userManagement"/></h2>
        ...
        <div class="floatingBox">
            <div class="container-fluid">
                <form:form  id="projectForm" class="form-horizontal contentForm" data-validate="parsley" method="post" action="" commandName="user">
                    ...
                    <div class="control-group">
                        <label class="control-label" for="passwordConf"><spring:message code="user.form.role" /> <span class="requiredField"> *</span></label>
                        <div class="controls">
                            <form:select path="role" id="userRole" >
                                <form:options items="${roles}" itemLabel="label" itemValue="value"/>
                            </form:select>
                            <ul id="parsley-6212773541919887" class="parsley-error-list" style="display: block;">

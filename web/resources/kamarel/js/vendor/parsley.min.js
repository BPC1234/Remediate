...
!function (d) {
    var h = function (a) {
        this.messages = {defaultMessage: "This value seems to be invalid.", type: {email: "This value should be a valid email.", url: "This value should be a valid url.", urlstrict: "This value should be a valid url.", number: "This value should be a valid number.", digits: "This value should be digits.", dateIso: "This value should be a valid date (MM/DD/YYYY).", alphanum: "This value should be alphanumeric.", phone: "This value should be a valid phone number."}, notnull: "This value should not be null.",
            ...
            maxcheck: "You must select %s choices or less.", rangecheck: "You must select between %s and %s choices.", equalto: "This value should be the same."};
        this.init(a)
    };
    h.prototype = {constructor: h, validators: {notnull: function (a) {
        ...
        switch (b) {
            ...
            case "urlstrict":
                ...
                break;
            case "dateIso":
//                c = /^(\d{4})\D?(0[1-9]|1[0-2])\D?([12]\d|0[1-9]|3[01])$/; for YYYY/MM/DD
                c = /^(0[1-9]|1[012])[- \/.](0[1-9]|[12][0-9]|3[01])[- \/.](19|20)\d\d$/ ;
    ...
    j.prototype = {constructor: j, init: function (a, b) {
        ...
        getHash: function () {
            ...
            var a = null, b;
            for (b in this.constraints)!1 === this.constraints[b].valid ? (this.manageError(this.constraints[b]), a = !1) : !0 === this.constraints[b].valid && (this.removeError(this.constraints[b].name),
                a = !1 !== a);
            this.valid = a;
            ...
            for (var b in a) {
                ...
                d(this.ulError).append(this.options.animate ? d(c).text(a[b]).hide().fadeIn(this.options.animateDuration) :
                    d(c).text(a[b]))
            }
            ...
            if (!("required" ===
                a.name && null !== this.getVal() && 0 < this.getVal().length) && (!this.isRequired || !("required" !== a.name && (null === this.getVal() || 0 === this.getVal().length)))) {

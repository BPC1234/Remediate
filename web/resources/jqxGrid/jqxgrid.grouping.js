...
(function (a) {
    ...
    a.extend(a.jqx._jqxGrid.prototype, {_initgroupsheader: function () {
        ...
        if (this._groupsheader()) {
            ...
            var customGroupsHeader = this.groupsheaderdiv;
            var b = new Array();
            if (d > 0) {
                    ...
                    if (e.closeablegroups) {
                        ...
                        if (e.isTouchDevice() && e.touchmode !== true) {
                            ...
                            e.addHandler(j, "click", function () {
                              //  var tableClassOrId = customGroupsHeader.parent('div').parent('div').parent('div').parent('div').attr('class').split(' ')[0];
                                //var originalTableIdOrClass = customGroupsHeader.parent('div').parent('div').parent('div').parent('div').attr('abbr');
                                //alert('tableClassOrId='+tableClassOrId+' originalTableIdOrClass='+originalTableIdOrClass)
                                //setActionOnCrossButton(tableClassOrId,originalTableIdOrClass);
                                setActionOnCrossButton();
                                e.removegroupat(i);
                                return false
                            })
                        }

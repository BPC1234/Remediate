...
(function (b) {
    ...
    b.extend(b.jqx._jqxDataTable.prototype, {defineInstance: function () {
        ...
        if (b(P.target).ischildof(this.filter)) {
            return true
        }
        ...
        var L = this._names();
        var E = this;
        var r = P.charCode ? P.charCode : P.keyCode ? P.keyCode : 0;
        var n = this._lastSelectedKey;
        var N = this.rowinfo[n];
        var u = this._getuirow(n);
        var w = P.shiftKey && this.selectionmode != "singlerow";
        var H = P.ctrlKey;
        if (!u) {
            return
        }
        if (E.handlekeyboardnavigation) {
            var t = E.handlekeyboardnavigation(r);
            if (t) {
                return true
            }
        }
        if (E.editable && E.editKey == undefined && r === 113 && E.editSettings.editOnF2) {
            E.beginroweditbykey(u.attr("data-key"))
        }
        if (E.editKey == undefined) {
            if (!H && !w && E.incrementalSearch && (!(r >= 33 && r <= 40))) {
                var x = -1;
                if (!E._searchString) {
                    E._searchString = ""
                }
                if ((r == 8 || r == 46) && E._searchString.length >= 1) {
                    E._searchString = E._searchString.substr(0, E._searchString.length - 1)
                }
                var d = String.fromCharCode(r);
                var D = (!isNaN(parseInt(d)));
                var F = false;
                if ((r >= 65 && r <= 97) || D || r == 8 || r == 32 || r == 46) {
                    if (!P.shiftKey) {
                        d = d.toLocaleLowerCase()
                    }
                    if (r != 8 && r != 32 && r != 46) {
                        if (!(E._searchString.length > 0 && E._searchString.substr(0, 1) == d)) {
                            E._searchString += d
                        }
                    }
                    if (r == 32) {
                    ...
                    E._searchTime = new Date();
                    var n = this.getselection();
                    if (n.length >= 1) {
                        var s = n[0].uid;
                        var A = -1;
                        for (var K = 0; K < this.renderedRecords.length; K++) {
                            if (this.renderedRecords[K].uid == s) {
                                A = K;
                                break
                            }
                        }
                        var z = this._getMatches(E._searchString, A);
                        if (z.length == 0 || (z.length > 0 && z[0] == s)) {
                            var z = this._getMatches(E._searchString)
                        }
                    } else {
                        var z = this._getMatches(E._searchString)
                    }
                    if (z.length > 0) {
                        var n = this.getselection();
                        if (n.length >= 1) {
                            var c = z.indexOf(n[0].uid);
                            if (c == -1) {
                                E.clearselection(false);
                                E.selectrowbykey(z[0])
                            } else {
                                var h = c + 1;
                                if (h >= z.length) {
                                    h = 0
                                ...
                                E.clearselection(false);
                                E.selectrowbykey(z[h])
                            }
                        } else {
                            E.clearselection(false);
                            E.selectrowbykey(z[0])
                        }
                        E._lastSearchString = E._searchString
                    }
                }
                if (E._searchTimer != undefined) {
        ...
        if (E.editKey != undefined) {
            if (r === 27 && E.editSettings.cancelOnEsc) {
                E.endroweditbykey(E.editKey, true)
            } else {
                if (r === 13 && E.editSettings.saveOnEnter) {
                    if (P.target && P.target.nodeName.toLowerCase() != "div" && P.target.nodeName.toLowerCase() != "input") {
                        return true
                    }
                    E.endroweditbykey(E.editKey, false)
                }
            }
            return true
        }
        if (P.ctrlKey) {
            ...
            if (f == "c" || f == "x") {
                ...
                if (n.length >= 1) {
                    var v = "";
                    for (var G = 0; G < this.renderedRecords.length; G++) {
                        var Q = this.renderedRecords[G];
                        for (var K = 0; K < n.length; K++) {
                            var o = n[K];
                            if (o.uid === Q.uid) {
                                for (var J = 0; J < this.columns.records.length; J++) {
                                    var y = this.getcelltextbykey(o.uid, this.columns.records[J].displayfield);
                                    v += y;
                                    if (J < this.columns.records.length - 1) {
                                        v += "\t"
                                    }
                                }
                                v += "\n";
                    ...
                    if (window.clipboardData) {
                        ...
                        var I = b('<textarea style="position: absolute; left: -1000px; top: -1000px;"/>');
                        I.val(v);
                        b("body").append(I);
                        I.select();
                        setTimeout(function () {
        ...
        var O = function (R) {
            var j = null;
            var p = b(E._table.children()[1]).children().length - 1;
            var i = b(b(E._table.children()[1]).children()[p]);
            var S = i.attr("data-role");
            if (!S) {
                j = i.attr("data-key")
            } else {
                while (i) {
        ...
        var g = function (p) {
            var j = null;
            var i = b(b(E._table.children()[1]).children()[0]);
            var R = i.attr("data-role");
            if (!R) {
                j = i.attr("data-key")
            } else {
                while (i) {
        ...
        var l = function () {
            ...
            E._lastSelectedKey = s;
            var j = E.rowsByKey[s];
            var i = E.getRows().indexOf(j);
            E._raiseEvent("rowSelect", {key: s, index: i, row: E.rowsByKey[s]});
            E._doSelection(s, true, true);
            E.host.focus()
        };
        var k = function () {
            E.clearselection(false);
            var i = g();
            if (w || H) {
                E._selectRange(u.index(), 0)
            } else {
                E._lastSelectedKey = i
            }
            E.selectrowbykey(i, "keyboard")
        };
        var q = function () {
            E.clearselection(false);
            var i = O("all");
            var j = i.key;
            if (w || H) {
                E._selectRange(u.index(), i.row.index())
            } else {
                E._lastSelectedKey = j
            }
            E.selectrowbykey(j, "keyboard")
        };
        ...
        if (r == 36 || (H && r == 38)) {
            ...
            if (r == 35 || (H && r == 40)) {
                ...
                if (r == 33 || r == 37) {
                    var s = u.attr("data-key");
                    if (this.rowdetails && r == 37 && !this.treeGrid) {
                        this.hidedetailsbykey(s);
                        return false
                    } else {
                        if (this.treeGrid && r == 37) {
                            if (this.rowinfo[s].row && !this.rowinfo[s].row[L.parent] && !this.rowinfo[s][L.leaf] && !this.rowinfo[s].expanded) {
                                return false
                            }
                            if (this.rowinfo[s].expanded && !this.rowinfo[s][L.leaf]) {
                                this.treeGrid.collapserow(s);
                                return false
                            } else {
                                if (this.rowinfo[s].row && this.rowinfo[s].row[L.parent]) {
                                    s = this.rowinfo[s].row[L.parent].uid
                                }
                            }
                            if (this.rowinfo[s][L.leaf]) {
                                return false
                            }
                        }
                    }
                    ...
                    if (this.treeGrid && this.pageable && r == 33) {
                        this.gotoprevpage(l);
                        return false
                    }
                } else {
                    if (r == 34 || r == 39) {
                        var s = u.attr("data-key");
                        if (this.rowdetails && r == 39 && !this.treeGrid) {
                            ...
                            if (this.treeGrid && r == 39) {
                                ...
                                if (!this.rowinfo[s].expanded) {
                                    this.treeGrid.expandrow(s);
                                    return false
                                } else {
                                    if (this.rowinfo[s].row && this.rowinfo[s].row.records && this.rowinfo[s].row.records.length > 0) {
                        ...
                        if (this.treeGrid && this.pageable && r == 34) {
                            this.gotonextpage(l);
                            return false
                        }
                    } else {
        ...
        if (s != null) {
            ...
            if (this.rowinfo[s]) {
                if (this.rowinfo[s].selected && (H || w)) {
                    this._doSelection(this._lastSelectedKey, false, false);
                    this._lastSelectedKey = s;
                    var o = this.rowsByKey[s];
                    var A = this.getRows().indexOf(o);
                    E._updateSelection();
                    this._raiseEvent("rowUnselect", {key: s, index: A, row: this.rowsByKey[s]});
                    return false
                }
            }
            this._lastSelectedKey = s;
            ...
            E._updateSelection();
            this._raiseEvent("rowSelect", {key: s, index: A, row: this.rowsByKey[s]});
            if (this.treeGrid) {
                if (r == 37) {
                    ...
                    if (this.pageable && M == null && this.dataview.pagenum > 0) {
                        while (this._getuirow(s) == null && this.dataview.pagenum > 0) {
                            this.gotoprevpage()
                        }
                    }
                } else {
        ...
        if (this.treeGrid) {
            ...
            var d = function (ad) {
                for (var ae = 0; ae < ad.length; ae++) {
                    var j = ad[ae];
                    var ac = j[Y.expanded] || (!j[Y.expanded] && aa);
                    if (j.records && j.records.length > 0 && ac) {
                        g++;
                        d(ad[ae].records);
                        break
                    }
            ...
            if (s != "xml" && s != "json") {
                ...
                var S = function (ae) {
                    for (var ag = 0; ag < ae.length; ag++) {
                        ...
                        var ad = ac[Y.expanded] || (!ac[Y.expanded] && aa);
                        if (s == "xls" || s == "html") {
                            if (ac.records && ac.records.length > 0) {
                        ...
                        if (ac.aggregate) {
                            ...
                            for (var af = g; af < o.length; af++) {
                                ...
                                if (ac[o[ah].displayfield] != undefined) {
                                    ac[o[ah].displayfield] = ai + ac[o[ah].displayfield]
                                }
                            }
                        }
                        x.push(ac);
        ...
        b.each(o, function (ae) {
            ...
            var af = function (ak) {
                ...
                ak.removeClass(am("jqx-cell"));
                ak.removeClass(am("jqx-grid-cell-selected"));
                ak.removeClass(am("jqx-fill-state-pressed"));
                ak.removeClass(am("jqx-grid-cell-hover"));
                ak.removeClass(am("jqx-fill-state-hover"));
                if (ad.customCellStyles) {
                    for (var al in ad.customCellStyles) {
                        ak.removeClass(ad.customCellStyles[al])
                    }
                }
            };
            af(ai);
            ...
            var ag = r._getexportcolumntype(this);
            ...
            if (s != "json" && s != "xml") {
                J = "column" + y;
                var i = function (ak, at, ar, al, aq, an, am, ao, ap) {
                    B[ak] = {index: 1 + am, maxIndex: o.length};
                    if (an.rtl) {
                        B[ak].index = o.length - am
                    }
                    if (s == "html" || s == "xls" || s == "pdf") {
                        if (at) {
                            B[ak]["font-size"] = at.css("font-size");
                            B[ak]["font-weight"] = at.css("font-weight");
                            B[ak]["font-style"] = at.css("font-style");
                            B[ak]["background-color"] = an._getexportcolor(at.css("background-color"));
                            B[ak]["color"] = an._getexportcolor(at.css("color"));
                            B[ak]["border-color"] = an._getexportcolor(at.css("border-top-color"))
                        }
                        if (ar) {
                        ...
                        if (s == "html" || s == "pdf") {
                            ...
                            if (!an.rtl) {
                                ...
                                if (am == o.length - g - 1 && ar) {
                                    B[ak]["border-right-width"] = "1px"
                                }
                            }
                            B[ak]["border-bottom-width"] = "1px";
                            if (at) {
                                B[ak]["border-top-style"] = at.css("border-top-style");
                                B[ak]["border-left-style"] = at.css("border-left-style");
                                B[ak]["border-right-style"] = at.css("border-right-style");
                                B[ak]["border-bottom-style"] = at.css("border-bottom-style")
                            }
                            if (ar) {
                                if (am == 0 && !an.rtl) {
                                    B[ak]["border-left-width"] = "1px"
                                } else {
                                    if (am == o.length - 1 && an.rtl) {
                                        B[ak]["border-right-width"] = "1px"
                                    }
                                }
                                if (at) {
                                    B[ak]["border-top-width"] = "1px";
                                    B[ak]["border-bottom-width"] = at.css("border-bottom-width")
                                }
                            } else {
                                if (am == 0 && !an.rtl) {
                                    B[ak]["border-left-width"] = "1px"
                ...
                i(J, aj, true, false, this, r, ae);
                y++;
                i(D, ai, false, false, this, r, ae);
                if (r.altrows) {
                    D = "cellalt" + A;
                    i(D, j, false, true, this, r, ae)
                }
                if (this.customCellStyles) {
                    for (var ac in ad.customCellStyles) {
                        ai.removeClass(ad.customCellStyles[ac])
                    }
                    for (var ac in ad.customCellStyles) {
                        ai.addClass(ad.customCellStyles[ac]);
                        i(D + ad.customCellStyles[ac], ai, false, false, this, r, ae, true, ac);
                        ai.removeClass(ad.customCellStyles[ac])
                    }
                }
                A++
                ...
                b.each(o, function (j) {
                    if (this.aggregates) {
                        for (var ad = 0; ad < this.aggregates.length; ad++) {
                            ...
                            if (F[ad]) {
                                var ae = r._getaggregatename(this.aggregates[ad]);
                                var af = r._getaggregatetype(this.aggregates[ad]);
                                var ac = z[j - N];
                                if (ac) {
                                    F[ad][this.displayfield] = M + ae + ": " + ac[af]
                                }
                            }
                        }
                    }
    ...
    }, beginroweditbykey: function (y) {
        if (this.editKey === y && this.editKey != undefined) {
            return false
        }
        if (this.rowinfo[y] && this.rowinfo[y].locked) {
            return false
        }
        if (this.editKey != null) {
            this.endroweditbykey(y, true);
            return false
        }
        var m = this;
        var k = this.rowsByKey[y];
        if (this.treeGrid) {
            var k = this.treeGrid.getrow(y)
        }
        var l = this.getRows().indexOf(k);
        var x = this._getuirow(y);
        var p = this._getpinneduirow(y);
        ...
        if (x) {
            ...
            for (var u = 0; u < g.length; u++) {
                ...
                var r = b(d).outerWidth();
                var s = b(d).width();
                if (q === 0) {
                    q = b(d).outerHeight() - 1
                }
                b(d).css("padding", "0px");
                cellContent = "<div style='height:" + q + "px; width: 100%; overflow: hidden; border-radius: 0px; -moz-border-radius: 0px; -webkit-border-radius: 0px; z-index: 9999;'></div>";
                var o = this.getcelltextbykey(y, f.displayfield);
                ...
                switch (f.columntype) {
                    ...
                    case"default":
                        ...
                        h[0].onfocus = function (i) {
                            setTimeout(function () {
                                if (i) {
                                    var z = b(i.target).parent().parent().index();
                                    m.ensurecolumnvisible(m.columns.records[z].datafield)
                                } else {
                                    var z = b(document.activeElement).parent().parent().index();
                                    if (z >= 0) {
                                        m.ensurecolumnvisible(m.columns.records[z].datafield)
                                    }
                                }
                        ...
                        h.height(q);
                        if (b.jqx.browser.msie && b.jqx.browser.version < 9) {
                            h.css("line-height", parseInt(q) + "px")
                        }
                        ...
                        if (f.createeditor) {
                            var w = o;
                            var o = this.getcellvaluebykey(y, f.displayfield);
                            f.createeditor(!this.treeGrid ? l : y, o, h, w, s, q)
                        }
                        ...
                        if (f.cellsformat != "") {
                            if (f.cellsformat.indexOf("p") != -1 || f.cellsformat.indexOf("c") != -1 || f.cellsformat.indexOf("n") != -1 || f.cellsformat.indexOf("f") != -1) {
                                h.keydown(function (z) {
                                    var F = z.charCode ? z.charCode : z.keyCode ? z.keyCode : 0;
                                    ...
                                    if (f.cellsformat.length > 1) {
                                        var E = parseInt(f.cellsformat.substring(1));
                                        if (isNaN(E)) {
                                            E = 0
                                        }
                                    } else {
                                    ...
                                    if (E > 0) {
                                        if (A.indexOf(m.gridlocalization.decimalseparator) != -1) {
                                            if (m._selection(h).start > A.indexOf(m.gridlocalization.decimalseparator)) {
                                                return true
                                            }
                                        }
                                    }
                                    for (var G = 0; G < A.length - E; G++) {
                                        var i = A.substring(G, G + 1);
                                        if (i.match(/^[0-9]+$/) != null) {
                                            B += i
                                        }
                                    }
                        ...
                        if (f.initeditor) {
                            var w = o;
                            var o = this.getcellvaluebykey(y, f.displayfield);
                            f.initeditor(!this.treeGrid ? l : y, o, h, w, s, q)
                        }
                        break;
                    case"custom":
                    case"template":
                        ...
                        var t = b.trim(f.datafield).split(" ").join("");
                        if (t.indexOf(".") != -1) {
                            t = t.replace(".", "")
                        }
                        var v = this.editorsCache["templateeditor_" + t];
                        if (f.columntype == "custom") {
                            var v = this.editorsCache["customeditor_" + t + "_" + y]
                        }
                        var w = o;
                        var o = this.getcellvaluebykey(y, f.displayfield);
                        if (!v) {
                            ...
                            if (f.columntype != "custom") {
                                this.editorsCache["templateeditor_" + t] = h
                            } else {
                                this.editorsCache["customeditor_" + t + "_" + y] = h
                            }
                            h.appendTo(j);
                            if (f.createeditor) {
                                f.createeditor(!this.treeGrid ? l : y, o, h, w, r, q)
                            }
                        } else {
                            var h = v;
                            h.width(r);
                        ...
                        if (f.initeditor) {
                            f.initeditor(!this.treeGrid ? l : y, o, h, w, r, q)
                        }
                        this._editors.push({column: f, editor: h});
                        break
                }
        ...
        this.editKey = y;
        this.beginupdate();
        this._raiseEvent("rowBeginEdit", {key: y, index: l, row: this.rowsByKey[y]});
                ...
                if (d) {
                    for (var u = 0; u < o.length; u++) {
                        ...
                        if (s && s.label != undefined) {
                            g[c.displayfield] = s.label;
                            g[c.datafield] = s.value
                        } else {
                            g[c.displayfield] = s
                        }
                        if (this.treeGrid) {
        ...
        if (j) {
            ...
            if (d) {
                ...
                if (!this.rtl) {
                    ...
                    e.removeClass(this.toThemeProperty("jqx-icon-arrow-right"));
                    e.addClass(this.toThemeProperty("jqx-icon-arrow-down"))
                } else {
                    e.removeClass(this.toThemeProperty("jqx-grid-group-collapse-rtl"));
                    e.addClass(this.toThemeProperty("jqx-grid-group-expand-rtl"));
                    e.removeClass(this.toThemeProperty("jqx-icon-arrow-left"));
                    e.addClass(this.toThemeProperty("jqx-icon-arrow-down"))
                }
                d.next().show();
                var g = f.next();
        ...
        if (h) {
            ...
            if (c) {
                ...
                if (!this.rtl) {
                    ...
                    g.addClass(this.toThemeProperty("jqx-icon-arrow-right"));
                    g.removeClass(this.toThemeProperty("jqx-icon-arrow-down"))
                } else {
                    g.addClass(this.toThemeProperty("jqx-grid-group-collapse-rtl"));
                    g.removeClass(this.toThemeProperty("jqx-grid-group-expand-rtl"));
                    g.addClass(this.toThemeProperty("jqx-icon-arrow-left"));
                    g.removeClass(this.toThemeProperty("jqx-icon-arrow-down"))
                }
                c.next().hide();
                d.next().hide();
        ...
        this._raiseEvent("columnReordered", {columntext: h.text, datafield: h.datafield, oldindex: l, newindex: i});
        this.resize();
        ...
        this.addHandler(b(document), f, function (k) {
            ...
            if (g.reordercolumn != null) {
                ...
                g.reordercolumn.css({left: r + "px", top: j + "px"});
                d = false;
        ...
        this.addHandler(b(document), e, function (k) {
            ...
            b.each(g.columns.records, function (o) {
                var p = this;
                if (p.hidden) {
                    g.columnsbounds[g.columnsbounds.length] = {top: l, column: p, left: m, width: 0, height: 2 + g.rowsheight};
                    return true
                }
                if (j == 0) {
                    if (!g.rtl) {
        ...
        b.each(this.columns.records, function (H, F) {
            ...
            var K = q.toTP("jqx-grid-column-header") + " " + q.toTP("jqx-widget-header");
            if (q.rtl) {
                K += " " + q.toTP("jqx-grid-column-header-rtl")
            }
            if (!q.enablebrowserselection) {
                K += " " + q.toTP("jqx-disableselect")
            }
            var I = !self.rtl ? 150 + u - 1 : 150 + u + 1;
            var D = !q.rtl ? u-- : u++;
            var w = b('<div role="columnheader" style="z-index: ' + D + ';position: absolute; height: 100%;" class="' + K + '"><div style="height: 100%; width: 100%;"></div></div>');
            if (q.rtl && H === 0) {
            ...
            if (this.width != "auto" && !this._width && !C) {
                ...
                if (C) {
                    ...
                    var E = Math.floor(t * (this.text.length / r.length));
                    if (isNaN(E)) {
                        E = this.minwidth
                    }
                    if (E < 0) {
            ...
            f.append(w);
            if (q.columnsreorder && this.draggable && q._handlecolumnsdragreorder) {
                q._handlecolumnsdragreorder(this, w)
            }
            var J = this;
            ...
            if (J.resizable && q.columnsresize && !G) {
                var x = false;
                var j = "mousemove";
                if (q.isTouchDevice()) {
                    x = true;
                ...
                q.addHandler(w, j, function (M) {
                    var i = parseInt(M.pageX);
                    var O = 5;
                    var R = parseInt(w.coord().left);
                    if (q.hasTransform) {
                        R = b.jqx.utilities.getOffset(w).left
                    }
                    if (q._handlecolumnsresize) {
                        if (x) {
                            var N = b.jqx.mobile.getTouches(M);
                            var Q = N[0];
                            i = Q.pageX;
                            O = 40;
                            if (i >= R + J.width - O) {
                                q.resizablecolumn = {columnelement: w, column: J};
                        ...
                        if (i >= R + P - O) {
                            ...
                            w.css("cursor", "");
                            if (i < R + P - O) {
                                if (!J._animating && !J._menuvisible) {
                                    w.mouseenter()
                                }
                            }
                            q.resizablecolumn = null
            ...
            if (J.rendered) {
                var z = J.rendered(b(k[0].firstChild), J.align, m);
                if (z && A != null) {
                    A.hide()
                }
            }
    ...
    }, _calculateaggregate: function (j, n, d, g) {
        var e = j.aggregates;
        if (!e) {
            e = n
        }
        if (e) {
            ...
            if (this.source && this.source.getAggregatedData) {
                ...
                if (this.treeGrid) {
                    ...
                    var q = function (t) {
                        for (var s = 0; s < t.length; s++) {
                            ...
                            if (!t[s].leaf && t[s].records && t[s].records.length > 0) {
                                q(t[s].records)
                            }
                        }
                    };
                ...
                if (d == undefined || d == true) {
                    var l = this.source.getAggregatedData([
                        {name: j.datafield, aggregates: e, formatStrings: f}
                    ], this.gridlocalization, g, c);
                    if (this.treeGrid) {
                        if (l[j.datafield].sum != undefined || l[j.datafield].avg != undefined) {
                            var h = this.source.getAggregatedData([
                                {name: j.datafield, aggregates: e, formatStrings: f}
                            ], this.gridlocalization, r, c);
                            if (l[j.datafield].sum != undefined) {
                                l[j.datafield].sum = h[j.datafield].sum
                            }
                            if (l[j.datafield].avg != undefined) {
                                l[j.datafield].avg = h[j.datafield].avg
                            }
                        }
                    }
                    return l

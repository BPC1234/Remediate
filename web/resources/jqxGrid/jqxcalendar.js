...
(function (a) {
    ...
    a.extend(a.jqx._jqxCalendar.prototype, {defineInstance: function () {
        ...
        if (this.view == "month") {
            ...
            if (g == "arrow" && this.selectableDays.length == 7) {
        ...
        if (this.view == "month") {
            ...
            if (f == "arrow" && this.selectableDays.length == 7) {
        ...
        if (this.view != "month") {
            ...
            a.each(this.renderedCells, function (n) {
                ...
                if (e == null) {
                    ...
                    j.isSelected = false;
                    if (o) {
                        if ((o.getMonth() == e.getMonth() && d.view == "year" && o.getFullYear() == e.getFullYear()) || (d.view == "decade" && o.getFullYear() == e.getFullYear())) {
                            j.isSelected = true;
                            try {
                                j.element.focus()
                            } catch (l) {
    ...
    }, _applyCellStyle: function (c, d, f) {
        var e = this;
        ...
        if (!c.isVisible) {
            ...
            if (this.view != "month") {
                if (f.length > 0 && f.html().toLowerCase().indexOf("span") != -1) {
                    f.css("cursor", "default")
                }
            }
        }
        f.removeAttr("aria-selected");
        if (c.isSelected && c.isVisible) {
            ...
            this.host.removeAttr("aria-activedescendant").attr("aria-activedescendant", f[0].id)
        }
        ...
        if (this.specialDates.length > 0) {
            ...
            a.each(this.specialDates, function () {
                if (this.Class != undefined && this.Class != null && this.Class != "") {
                    f.removeClass(this.Class)
                } else {
                    f.removeClass(e.toThemeProperty("jqx-calendar-cell-specialDate"))
                }
                var h = c.getDate();
                if (h.getFullYear() == this.Date.getFullYear() && h.getMonth() == this.Date.getMonth() && h.getDate() == this.Date.getDate()) {
                    if (c.tooltip == null && this.Tooltip != null) {
                        c.tooltip = this.Tooltip;
                        if (a(f).jqxTooltip) {
                            var i = this.Class;
                            a(f).jqxTooltip({value: {cell: c, specialDate: this.Date}, name: g.element.id, content: this.Tooltip, position: "mouse", theme: g.theme, opening: function (j) {
                                if (f.hasClass(e.toThemeProperty("jqx-calendar-cell-specialDate"))) {
                                    return true
                                }
                                if (f.hasClass(i)) {
                                    return true
                    ...
                    f.removeClass(e.toThemeProperty("jqx-calendar-cell-othermonth"));
                    f.removeClass(e.toThemeProperty("jqx-calendar-cell-weekend"));
                    if (this.Class == undefined || this.Class == "") {
                        f.addClass(e.toThemeProperty("jqx-calendar-cell-specialDate"));
                        return false
                    } else {
                        f.addClass(this.Class);
                        return false
                    }
                }
            })

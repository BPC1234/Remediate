                                    ...
                                    for (var au = 0; au < aa; au++) {
                                        ...
                                        if (at != undefined && (at.name == av)) {
                                            ...
                                            if (at != undefined && at.map && (at.map.indexOf(av) >= 0)) {
                                                ...
                                                if (aB != "string") {
                                                    aC = ae.getvaluebytype(aC, {type: aB})
                                                }
                                                ah[az] = aC;
                                                if (ah[az] != undefined) {
                            ...
                            if (ae._oldrecords) {
                                ...
                                if (X == "update") {
                                    if (ae._oldrecords[ag]._koindex != al) {
                                        var an = {index: ag, oldrecord: ae._oldrecords[ag], record: ah};
            ...
            case"text":
                ...
                if (U.url && U.url.length > 0) {
                    if (i.isFunction(K.loadServerData)) {
                        ...
                        this.xhr = i.jqx.data.ajax({dataType: Q, cache: this.cache, type: J, url: U.url, async: N, contentType: Y, data: ac, success: function (aj, ag, am) {
                            if (i.isFunction(U.beforeprocessing)) {

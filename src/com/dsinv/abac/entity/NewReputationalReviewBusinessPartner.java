...
public class NewReputationalReviewBusinessPartner extends AbstractBaseEntity{
	...
	private List<WorldCompliance> wcList;
	private String selectedWCText;
	...
	public List<WorldCompliance> getWcList() {
		return wcList;
	}
	public void setWcList(List<WorldCompliance> wcList) {
		this.wcList = wcList;
	}
	public String getSelectedWCText() {
		return selectedWCText;
	}
	public void setSelectedWCText(String selectedWCText) {
		this.selectedWCText = selectedWCText;
	}	
}
